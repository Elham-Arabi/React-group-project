...
const FooterComponent = () => {
  ...
  return (
    <Footer style={{ backgroundColor: "#15151d", color: "#fff", padding: "10px 300px" }}>
      <Row justify="space-between" gutter={[16, 16]}>
        ...
        <Col span={6}>
          ...
          <Menu mode="vertical" theme="dark" style={{ backgroundColor: "transparent", border: "none" }}>
      ...
      <Row justify="center" style={{ marginTop: "20px", borderTop: "1px solid #444", paddingTop: "10px" }}>
        <Col>
