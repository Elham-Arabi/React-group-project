...
const HeaderComponent = () => {
    ...
    <Menu>
      {categories.length > 0 ? (
        categories.map((category) => (
          <Menu.Item key={category._id} onClick={() => handleCategorySelect(category.name)}>
            {category.name}
          </Menu.Item>
        ))
      ) : (
  ...
  return (
    <Layout>
      <div style={{ backgroundColor: '#000', color: '#fff', padding: '10px 300px 10px' }}>
        <Row justify="space-between">
          <Col>
            <Space size="large">
              <span>
                <LocalPhoneIcon style={{ color: '#d31837' }} />{' '}
                <a href="tel:+09375291734" style={{ color: '#fff', textDecoration: 'none' }}>
                  09375241374
                </a>
              </span>
              <span>
                <EmailIcon style={{ color: '#d31837' }} />{' '}
                <a href="mailto:earabi@gmail.com" style={{ color: '#fff', textDecoration: 'none' }}>
                  earabi@gmail.com
                </a>
              </span>
              <span>
          ...
          <Col>
            <Space size="large">
              ...
              <a href="#account" style={{ color: '#fff', textDecoration: 'none' }}>
